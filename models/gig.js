...
GigSchema.plugin(mongooseAlgolia,{
  appId: '57FUNDOU3R',
  apiKey: 'ad54f377b82ac479ce6b9c78e9c8e11b',
...
Model.SetAlgoliaSettings({
  searchableAttributes: ['title','owner.name','shows'] //Sets the settings for this schema, see [Algolia's Index settings parameters](https://www.algolia.com/doc/api-client/javascript/settings#set-settings) for more info.
});
